...
const I18nController = (() => {
    const translations = {
        pt: {
            ...
            "contact.message": "Entre em contato com a Stammers!",
            ...
            "bio.paragraph1": "A Stammer é a prova viva de que o rock autoral brasileiro ainda pulsa forte e tem muito a dizer. Com influências que vão do hard rock clássico aos elementos modernos do rock contemporâneo, a banda entrega um som autêntico, poderoso e cheio de personalidade.",
            "bio.paragraph2": "Formada por músicos experientes e apaixonados pela arte, a Stammer se destaca não só pela técnica apurada, mas pela energia crua e visceral que imprime em cada apresentação ao vivo. Com presença marcante e letras que misturam paixão, fé, crítica e introspecção.",
            ...
            "bio.paragraph4": "Stammer não é só música — é identidade, resistência e paixão. É o grito de quem acredita que o rock ainda pode emocionar, transformar e unir.",
            "bio.paragraph5": "Gravado e produzido com peso e alma no Shokran Studios.",
            "footer.copyright": "© 2025 Stammers. Todos os direitos reservados."
            // ... outras traduções
        },
        en: {
            "title": "Stammers - Rock Band",
            ...
            "contact.message": "Get in touch with Stammers!",
            ...
            "bio.paragraph1": "Stammer is living proof that Brazilian original rock is still going strong and has a lot to say. With influences ranging from classic hard rock to modern elements of contemporary rock, the band delivers an authentic, powerful and personality-filled sound.",
            "bio.paragraph2": "Formed by experienced musicians passionate about their art, Stammer stands out not only for their refined technique but also for the raw, visceral energy they bring to each live performance. Their striking presence and lyrics blend passion, faith, critique, and introspection.",
            ...
            "bio.paragraph4": "Stammer is not just music — it is identity, resistance and passion. It is the cry of those who believe that rock can still move, transform and unite.",
            "bio.paragraph5": "Recorded and produced with weight and soul at Shokran Studios.",
            "footer.copyright": "© 2025 Stammers. All rights reserved."
            // ... outras traduções
        }
    };
